...
const BookUpdate = ({book}) => {
    ...
    const [selectedFile, setSelectedFile] = useState(book?.img)
    ...
    return (
        ...
        <>
            <Button variant='contained' sx={{ margin: '7px' }} onClick={() => setAddModal(true)}>Edit</Button>
            <Modal
                open={addModal}
                ...
                <Box sx={isNonMobileScreens ? style : styleMobile}  >
                    ...
                    <div className="modalBtn">
                        ...
                        <Button variant='contained' sx={{ margin: '7px' }} onClick={() => {
                            addBooks({ ...data, img: selectedFile,  })
                            setAddModal(false)
